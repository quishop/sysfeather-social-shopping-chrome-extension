...
try {
    if (isFacebookPostUrl(window.location.href)) {
        ...
        //     }
        // }
        // const val = startFetchCommitComments(document.querySelector('.x1gslohp'), []);
        // console.log('test 123:', document.querySelector('.x1gslohp'));
...
function isFacebookPostUrl(url: string) {
    ...
    const regex1 = /^https:\/\/www\.facebook\.com\/(\d+)\/posts\/(\d+)\/$/;
    return regexPermalink.test(url) || regex1.test(url);
}
